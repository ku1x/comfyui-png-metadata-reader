...
Features:
- External image input (from KJ nodes, etc.)
...
# Import the modified Simple Readable Metadata nodes
from .Simple_Readable_Metadata_External_Input_SG import SimpleReadableMetadataFromImage
